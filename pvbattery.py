...
def power_flows(mod_irrads, P_l, A_pv, P_max_inv, E_batt_max, P_max_batt_charge, P_max_batt_discharge,
    ...
    # TODO: add functionality for multiple orientations and surfaces
    ...
    :param A_pv: surface area of PV modules
    ...
    :returns: pandas DataFrame with load power, ghi, PV power after inverter, power taken from the grid,
    ...
    for i in tqdm(range(len(df))):
        ...
        P_pv[i] = min(eta_pv * eta_inv * A_pv * df['mod irrad'][i], P_max_inv)
...
if __name__ == '__main__':
    ...
    df_flows = power_flows(mod_irrads=mod_irrads, P_l=P_l, A_pv=5, P_max_inv=3, E_batt_max=4,
